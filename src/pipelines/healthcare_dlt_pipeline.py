...
# MAGIC %md
# MAGIC ## Gold Layer: Simple Summary Tables
# MAGIC
# MAGIC **Note:** Cost optimization demo (skewed joins, salting) moved to separate notebook
# MAGIC 
# MAGIC See: `notebooks/optimization_demo.py` for full Spark UI visibility on classic cluster
